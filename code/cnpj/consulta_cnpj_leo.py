...
def abrir_sessao_postgre(config):
    bd = psycopg2.connect(host="127.0.0.1", database="sa", user="postgres", password="POSTGRES", port=5434)
    return bd
...
''' Main program '''
def main():
    arquivo = r'C:\Users\Leonardo\OneDrive\Estudo\PSBI~1-DESKTOP-LUOCPGV\Trabalho BI 2019.2\dados\dados_segregados\leonardo\leo.txt'
    tipo = "txt"
